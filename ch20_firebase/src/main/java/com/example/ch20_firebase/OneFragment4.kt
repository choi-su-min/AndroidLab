...
import com.example.ch20_firebase.databinding.FragmentOne4Binding
...
class OneFragment4 : Fragment() {
    ...
    override fun onCreateView(
        ...
        val binding = FragmentOne4Binding.inflate(inflater, container, false)

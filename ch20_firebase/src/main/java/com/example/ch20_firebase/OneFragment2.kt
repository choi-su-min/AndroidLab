...
import com.example.ch20_firebase.databinding.FragmentOne2Binding
...
class OneFragment2 : Fragment() {
    ...
    override fun onCreateView(
        ...
        val binding = FragmentOne2Binding.inflate(inflater, container, false)
        val userNum = arguments?.getString("usernum")

        val studentMajorList: ArrayList<CourseListType> = arrayListOf()
        val studentLiberalList: ArrayList<CourseListType> = arrayListOf()

...
import com.example.ch20_firebase.databinding.FragmentOne3Binding
...
class OneFragment3 : Fragment() {
    ...
    override fun onCreateView(
        ...
        val binding = FragmentOne3Binding.inflate(inflater, container, false)
